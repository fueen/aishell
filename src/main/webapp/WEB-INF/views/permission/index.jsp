...
<table id="tt" class="easyui-datagrid"
       url="/permission/page" fitColumns="true"
       title="权限列表" iconCls="icon-man"
...
<div id="editDialog" class="easyui-dialog" title="添加/修改" style="padding: 20px; width:600px;height:500px;"
    ...
    <form id="editForm" method="post">
        <table style="margin: auto;width: 400px;height: 300px;padding-top: 50px;">
            ...
            <tr>
                <td style="font-weight: bold;font-family: '华文中宋';font-size: 20px;width: 50px">编码</td>
                <td style="padding-left: 10px;border: 0px;width: 50px;height: 50px;text-align: center">
                    <input style="width: 200px;border: 4px #000 solid;font-size: 20px;text-align: center; font-weight: bold;font-family: '幼圆';border-radius: 20px;" class="easyui-validatebox" type="text" name="sn" data-options="required:true" />
                </td>
            </tr>
            <tr>
                <td style="font-weight: bold;font-family: '华文中宋';font-size: 20px;width: 50px">路径</td>
                <td style="padding-left: 10px;border: 0px;width: 50px;height: 50px;text-align: center">
                    <input style="width: 200px;border: 4px #000 solid;font-size: 20px;text-align: center; font-weight: bold;font-family: '幼圆';border-radius: 20px;" class="easyui-validatebox" type="text" name="url" data-options="required:true" />
                </td>
            </tr>
            <tr>
                <td style="font-weight: bold;font-family: '华文中宋';font-size: 20px;width: 50px">描述</td>
                <td style="padding-left: 10px;border: 0px;width: 50px;height: 50px;text-align: center">
                    <input style="width: 200px;border: 4px #000 solid;font-size: 20px;text-align: center; font-weight: bold;font-family: '幼圆';border-radius: 20px;" class="easyui-validatebox" type="text" name="descs" data-options="required:true" />
                </td>
            </tr>
