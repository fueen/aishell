...
<table id="tt" class="easyui-datagrid"
       url="/systemDictionarydetail/page" fitColumns="true"
...
>
    ...
    <tr>
        ...
        <th data-options="field:'systemDictionaryType',width:100,formatter:typeFormat">字典类型</th>
...
<div id="editDialog" class="easyui-dialog" title="添加/修改" style="padding: 20px; width:600px;height:500px;"
    ...
    <form id="editForm" method="post">
        <table style="margin: auto;width: 400px;height: 300px;padding-top: 50px;">
            ...
            <tr>
                <td style="font-weight: bold;font-family: '华文中宋';font-size: 20px;width: 50px">字典类型</td>
                <td style="padding-left: 10px;border: 0px;width: 50px;height: 50px;text-align: center">
                    <input id="systemDictionarydetailList" class="easyui-combobox" name="systemDictionaryType.id"
                           data-options="valueField:'id',textField:'name',
                   url:'/systemDictionaryType/list',panelHeight:'auto'"/>
                </td>
            </tr>
