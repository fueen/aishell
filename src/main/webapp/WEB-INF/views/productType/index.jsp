...
<table id="tt" class="easyui-datagrid"
       url="/productType/page" fitColumns="true"
...
>
    ...
    <tr>
        ...
        <th data-options="field:'descs',width:100">产品名称</th>
        <th data-options="field:'productType',width:100,formatter:typeFormat">产品编号</th>
